...
$Stulicense = "DecaturPublicSchools:OFFICESUBSCRIPTION_STUDENT" #Use get-msolaccountsku to find the right SKU that you wish to assign.
$stafflicense = "DecaturPublicSchools:OFFICESUBSCRIPTION_STUDENT" #Use get-msolaccountsku to find the right SKU that you wish to assign.
